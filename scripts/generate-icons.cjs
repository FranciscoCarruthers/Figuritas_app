...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
  ...
  <circle cx="256" cy="168" r="78" fill="#38bdf8"/>
  <path d="M176 176h160v178c0 25-20 45-45 45h-70c-25 0-45-20-45-45V176Z" fill="#f8fafc"/>
  <path d="M203 226h106M203 272h106M203 318h76" stroke="#0f172a" stroke-width="26" stroke-linecap="round"/>
  <path d="M176 176h160v50H176z" fill="#facc15"/>
</svg>
`
