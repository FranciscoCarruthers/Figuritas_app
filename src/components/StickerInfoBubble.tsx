...
export default function StickerInfoBubble({
  ...
  return (
    ...
    >
      <span className="pointer-events-none fixed inset-x-4 top-[calc(5.25rem+env(safe-area-inset-top))] mx-auto block max-w-sm rounded-xl border border-slate-200 bg-white p-4 text-left shadow-2xl shadow-slate-950/20">
